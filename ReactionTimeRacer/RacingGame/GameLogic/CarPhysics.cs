    ...
    public class CarPhysics : BasePlayer
    {
        ...
        public override void Update()
        {
            ...
            if (Input.KeyboardKeyJustPressed(Keys.T))
            {
                ...
                RacingGameManager.Landscape.AddObjectToRender("Sign", Matrix.CreateTranslation(hazardSpawn), false);
            ...
            if (Input.KeyboardKeyJustPressed(Keys.B))
            {
                ...
                RacingGameManager.Landscape.AddObjectToRender("Sign", Matrix.CreateTranslation(CarPosition.X + 30, spawnY1, CarPosition.Z), false);
                HazardVectors[HazardVector] = new Vector3(CarPosition.X + 20, spawnY1, CarPosition.Z);
                HazardVector++;

                RacingGameManager.Landscape.AddObjectToRender("Sign", Matrix.CreateTranslation(CarPosition.X + 30, spawnY2, CarPosition.Z), false);
                HazardVectors[HazardVector] = new Vector3(CarPosition.X + 20, spawnY2, CarPosition.Z);
                HazardVector++;

                RacingGameManager.Landscape.AddObjectToRender("Sign", Matrix.CreateTranslation(CarPosition.X + 30, spawnY3, CarPosition.Z), false);
